...
sudo nala install -y gdm3 nautilus adwaita-icon-theme-full fonts-cantarell gnome-calendar gnome-music totem gnome-software gnome-software-plugin-flatpak firefox ppa-purge gnome-calculator
